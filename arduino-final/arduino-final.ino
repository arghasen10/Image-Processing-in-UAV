 ...
 while(gpsSerial.available())
  {
    ...
    //Serial.print("GPS Data:   ");  Serial.println(data);
    if(gps.encode(data)) 
  {
...
void writeBT()
{
//  Serial2.print("Date: ");   Serial2.print(dat);  Serial2.print("Time : ");   Serial2.println(tim);
//  Serial2.println("------------  SENSOR  DATA  -------------------");
//  Serial2.print("Latitude      : ");     Serial2.print(lati);        Serial2.println(" ");
//  Serial2.print("Latitude      : ");     Serial2.print(lon);         Serial2.println(" ");
//  Serial2.print("PM1   Value   : ");     Serial2.print(pm1val);      Serial2.println("ppm ");
//  Serial2.print("PM2.5 Value   : ");     Serial2.print(pm2_5val);    Serial2.println("ppm ");
//  Serial2.print("PM10  Value   : ");     Serial2.print(pm10_val);    Serial2.println("ppm ");
//  Serial2.print("NO2   Value   : ");     Serial2.print(no2_val);     Serial2.println("ppm ");
//  Serial2.print("CO2   Value   : ");     Serial2.print(co2_val);     Serial2.println("ppm ");
//  Serial2.print("CO    Value   : ");     Serial2.print(co_val);      Serial2.println("ppm ");
//  Serial2.print("Humidity      : ");     Serial2.print(humid_val);   Serial2.println("g/m3 ");
//  Serial2.print("Temperature   : ");     Serial2.print(temper_val);  Serial2.println("°C ");

 // Serial2.println(lati+","+lon+","+pm1val+","+pm2_5val+","+pm10_val+","+no2_val+","+co2_val+","+co_val+","+humid_val+","+temper_val+","+dat+","+tim);
  Serial2.println(dat+","+tim+","+pm1val+","+pm2_5val+","+pm10_val+","+no2_val+","+co2_val+","+co_val+","+humid_val+","+temper_val);
